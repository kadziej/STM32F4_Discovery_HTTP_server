...
/**
  ...
  * @retval None
  */
void LwIP_Init(Settings_struct *ip_settings)
{
  ...
  IP4_ADDR(&ipaddr, ip_settings->ip[0], ip_settings->ip[1], ip_settings->ip[2], ip_settings->ip[3]);
  IP4_ADDR(&netmask, ip_settings->ip_mask[0], ip_settings->ip_mask[1] , ip_settings->ip_mask[2], ip_settings->ip_mask[3]);
  IP4_ADDR(&gw, ip_settings->ip_gw[0], ip_settings->ip_gw[1], ip_settings->ip_gw[2], ip_settings->ip_gw[3]);
#ifdef USE_LCD 
  iptab[0] = IP_ADDR3;
  iptab[1] = IP_ADDR2;
  iptab[2] = IP_ADDR1;
